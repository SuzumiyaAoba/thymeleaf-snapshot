...
/**
 * Demonstrates named snapshots: a single test method asserts multiple rendering states, each stored
 * under a distinct snapshot name.
 */
...
class UserProfileTest {
  ...
  void shouldRenderDifferentRoles(Snapshot snapshot) {
    snapshot
        .setVariable("user", new User("Alice", "Platform engineer", "admin"))
