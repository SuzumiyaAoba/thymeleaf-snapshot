...
class SnapshotMismatchExceptionTest {
  ...
  void shouldContainDiffInMessage() {
    ...
    SnapshotMismatchException exception = new SnapshotMismatchException(path, expected, actual);
  ...
  void generateUnifiedDiffSingleInsertionLeavesUnchangedLinesAsContext() {
    ...
    assertThat(diff).as("inserted line should appear as addition").contains("+inserted");
    assertThat(diff)
  ...
  void generateUnifiedDiffSingleDeletionLeavesUnchangedLinesAsContext() {
    ...
    assertThat(diff).as("deleted line should appear as removal").contains("-deleted");
    assertThat(diff)
