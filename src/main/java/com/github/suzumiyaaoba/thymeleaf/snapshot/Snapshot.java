 ...
 *
 * <p>An instance of this class is injected into test methods annotated with
 * {@link SnapshotTest}. It provides a fluent interface for setting template
 * variables and asserting that the rendered output matches a stored snapshot.</p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
...
public final class Snapshot {
    ...
    /**
     * Creates a new Snapshot instance. This constructor is used internally by
     * {@link ThymeleafSnapshotExtension}.
     *
     ...
     */
    Snapshot(ThymeleafRenderer renderer, SnapshotManager snapshotManager,
             String testClassName, String testMethodName,
             SnapshotTest annotation, boolean prettyPrint, boolean globalUpdate) {
     ...
     *
     * <p>Defaults to {@link Locale#ROOT} for environment-independent snapshots.
     * Call this method when locale-sensitive formatting (e.g. date, number) is
     * intentionally under test.</p>
     *
     ...
     *
     * <p>Useful when asserting multiple snapshots within a single test
     * where each snapshot should start with a clean variable set.</p>
     *
     * @return this snapshot instance for chaining
     */
     ...
     *
     * <p>If no snapshot exists, one is created automatically and the test passes.
     * If a snapshot exists, the rendered output is compared against it.
     * If they don't match, a {@link SnapshotMismatchException} is thrown with
     * a detailed diff.</p>
     *
     ...
     *
     * <p>Use this when you need multiple snapshots within a single test method.
     * Each snapshot name must be unique within the test method.</p>
     *
    ...
    public void assertMatchesSnapshot(String snapshotName) {
        ...
        Path snapshotPath = snapshotManager.resolveSnapshotPath(testClassName, testMethodName, snapshotName);
