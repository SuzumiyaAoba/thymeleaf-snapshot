 ...
 *
 * <p>This class manages the configuration and lifecycle of the Thymeleaf
 * {@link TemplateEngine}, supporting both classpath-based and inline templates.</p>
 */
public final class ThymeleafRenderer {
    ...
    private static TemplateEngine createClasspathEngine(String prefix, String suffix, String characterEncoding) {
