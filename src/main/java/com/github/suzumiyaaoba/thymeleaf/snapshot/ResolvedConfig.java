...
/**
 * Resolved configuration values for a snapshot test, derived from the
 * {@link SnapshotConfig} annotation or defaults.
 *
 * <p>This record consolidates all configuration in a single immutable
 * object, eliminating the need to pass many individual parameters.</p>
 */
record ResolvedConfig(
    ...
    /**
     * Creates a {@link ResolvedConfig} from a {@link SnapshotConfig} annotation.
     * If the annotation is {@code null}, default values are used.
     *
