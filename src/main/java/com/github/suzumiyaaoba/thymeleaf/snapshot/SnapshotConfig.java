 ...
 *
 * <p>Apply this annotation to a test class to customize the Thymeleaf template engine
 * settings and snapshot storage options.</p>
 *
 * <pre>{@code
...
public @interface SnapshotConfig {
    ...
    /**
     * Prefix for resolving template names.
     * Templates are loaded from the classpath relative to this prefix.
    ...
    /**
     * Directory name for storing snapshot files, relative to
    ...
    /**
     * Whether to pretty-print the rendered HTML before storing as a snapshot.
     * When enabled, the HTML is formatted using Jsoup for better readability
     * and more meaningful diffs.
